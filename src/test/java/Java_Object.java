...
public class Java_Object {
    ...
    public void spartnaPojo(){
        ...
        System.out.println("Name " + spartan15Obj);

    }
    @Test
    public void spartanPojoList(){
        Response response=  given()
                .log().all()
                .contentType(ContentType.JSON).
                        when()
        ...
        List<Spartan> spartanPojoList = jpresponse.getList("", Spartan.class);
        System.out.println("SpartanPojoList = " + spartanPojoList);
        String nameSpartan21 = spartanPojoList.get(20).getName();
        System.out.println("nameSpartan21 " + nameSpartan21);
